...
public class Graph {
    ...
    public enum PrintGraphType {ORIGIN, DISTANCE, ALL_PATH, SINGLE_PATH, PRIORITY, X, Y, VISIT_CNT}
    ...
    public class Grid {
        ...
        int visitCnt = 0;  //Debug: count how many times this grid is visited and recalculated.
            ...
            switch (type) {
                ...
                case VISIT_CNT:
                    if (grid.visitCnt == 0) {
                        ...
                        gridStr = String.format("%2d", grid.visitCnt);
                    }
                    break;
                case ALL_PATH:
                    gridStr = "  ";
